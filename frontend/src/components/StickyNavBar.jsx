    ...
    return (
        <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            ...
            <div className="items-center justify-between hidden md:flex md:w-auto md:order-1" id="navbar-sticky">
                <div>
                    <img className="w-10 mx-4" src="./src/assets/menu.png" alt="menu"/>
                </div>
            ...
            <div className="flex flex-row items-center md:order-2">
                <img src="./src/assets/avatar.png" className="mx-3 h-10" alt="Flowbite Logo"/>
                <div className="flex flex-col items-start">
                    <span className="text-gray-900 dark:text-gray-100 text-md">Tram Dang</span>
                    <span className="text-gray-900 dark:text-gray-100 text-xs">Student</span>
                </div>
            </div>    
